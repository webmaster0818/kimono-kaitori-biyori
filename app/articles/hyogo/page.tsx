  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-12 rounded-2xl p-6 md:p-10 border border-[#e8ddd0]" style={{ backgroundImage: "linear-gradient(135deg, rgba(248,243,250,0.45), rgba(252,248,242,0.40)), url('/images/heroes/hyogo.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
        ...
        <section id="oshigai" className="mb-12">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            不安を感じたら、<a href="https://web.pref.hyogo.lg.jp/kf13/shohiseikatsu/madoguchi/kenmadoguchi.html" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">兵庫県立消費生活総合センター</a>（相談ダイヤル 078-303-0999）または全国共通の消費者ホットライン「<span className="font-bold">188</span>」に相談してください。※連絡先は2026年7月に公式サイトで確認。契約前の心構えは<Link href="/articles/trouble-prevention/" className="text-[#6b4c8a] underline">着物買取のトラブル回避ガイド</Link>もあわせてご覧ください。
          </p>
