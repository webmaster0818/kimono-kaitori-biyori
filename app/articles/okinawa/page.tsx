      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <nav className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6 mb-12">
          ...
          <ol className="space-y-2 text-sm text-[#6b4c8a]">
            ...
            <li><a href="#local-support" className="hover:underline">5. 訪問購入のクーリング・オフと沖縄県の相談窓口</a></li>
        ...
        <section id="local-support" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">5.</span> 訪問購入のクーリング・オフと沖縄県の相談窓口
          </h2>
          ...
          <div className="border border-[#e8ddd0] rounded-lg p-5 mb-4">
            ...
            <ul className="text-sm text-gray-700 leading-relaxed space-y-2">
              <li>
                <a href="https://www.pref.okinawa.jp/kurashikankyo/shohi/1017865/index.html" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">沖縄県消費生活センター</a>
