...
export const metadata: Metadata = {
  title: "【2026年最新】宮崎の着物買取おすすめ5選｜本場大島紬（都城）を高く売る",
  description:
    "宮崎県で着物買取を依頼するならどこがおすすめ？都城が産地の本場大島紬など宮崎が誇る織物の買取相場と、出張・持込・宅配に対応したおすすめ業者5選を比較。証紙の重要性や高く売るコツも解説します。",
  alternates: {
    canonical: "https://kimonokaitori-biyori.com/articles/miyazaki/",
  },
  openGraph: {
    title: "【2026年最新】宮崎の着物買取おすすめ5選｜本場大島紬（都城）を高く売る",
    description:
      "宮崎県で着物を高く売るためのおすすめ買取業者5選。本場大島紬（都城）など地元織物の買取相場も解説。",
    url: "https://kimonokaitori-biyori.com/articles/miyazaki/",
    siteName: "着物の買取びより",
    type: "article",
    locale: "ja_JP",
  },
...
const faqs = [
  { question: "宮崎の本場大島紬は高く売れますか？", answer: "本場大島紬は宮崎を代表する織物で、状態と証紙が揃っていれば評価されます。上質な手織りや証紙付き・作家物のものは特に高く、証紙がないと査定額が下がることがあるため、購入時の証紙は必ず一緒に査定へ出しましょう。正絹の紬・訪問着・帯と一緒にまとめて査定に出すと、全体の買取額が上がりやすくなります。" },
  ...
  { question: "宮崎県内で着物の出張買取は無料で来てもらえますか？", answer: "主要な着物買取業者であれば、宮崎市・都城市・延岡市・日向市など県内全域で無料の出張買取に対応しています。買取大吉やウリエルは出張費・査定料・キャンセル料すべて無料で、自宅にいながら査定を受けられます。まずは電話やLINEで対応エリアを確認するとスムーズです。" },
  { question: "宮崎で大量の着物をまとめて売れますか？", answer: "はい、出張買取を利用すれば点数制限なく大量の着物をまとめて売却できます。蔵や箪笥に眠っている着物・帯・和装小物をまとめて査定してもらうことで、1点ずつでは値がつきにくい品もまとめ買取で評価されるケースがあります。遺品整理や生前整理でまとまった量がある場合は、事前に点数を伝えておくとスムーズです。" },
  { question: "宮崎の着物買取で注意すべき点はありますか？", answer: "突然訪問してきて着物や貴金属の買取を持ちかける「押し買い」には注意してください。信頼できる業者が自ら飛び込み営業をすることはありません。古物商許可を持ち、口コミや実績が確認できる業者を選び、必ず複数社で相見積もりを取りましょう。出張買取は契約日を含め8日間のクーリングオフ対象です。" },
];
...
const articleStructuredData = {
  ...
  headline: "宮崎の着物買取おすすめ5選｜本場大島紬（都城）を高く売る",
  description:
    "宮崎県で着物を高く売るためのおすすめ買取業者5選。本場大島紬（都城）など地元織物の買取相場も解説。",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://kimonokaitori-biyori.com/articles/miyazaki/",
  },
};
...
const breadcrumbStructuredData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "宮崎の着物買取", item: "https://kimonokaitori-biyori.com/articles/miyazaki/" },
  ],
};

const orimono = [
  { name: "本場大島紬（都城）", note: "都城は本場大島紬の主要産地。締機の精緻な絣と泥染め・草木染が魅力。証紙が価値の決め手。" },
  { name: "龍郷柄・亀甲柄", note: "大島紬の代表的な伝統柄。精緻な絣ほど手間がかかり評価が高い。" },
  { name: "正絹の訪問着・紬", note: "大島紬以外の上質な着物も買取対象。証紙付き・作家物は高評価。" },
...
export default function MiyazakiPage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ label: "お役立ち情報", href: "/articles/" }, { label: "宮崎の着物買取" }]} />

      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-12 rounded-2xl p-6 md:p-10 border border-[#e8ddd0]" style={{ backgroundImage: "linear-gradient(135deg, rgba(248,243,250,0.45), rgba(252,248,242,0.40)), url('/images/heroes/miyazaki.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
            宮崎の着物買取おすすめ<span className="text-[#6b4c8a]">5選</span>
            <br className="md:hidden" />
            本場大島紬を高く売る
          </h1>
          <p className="text-gray-600 leading-relaxed">
            宮崎は、都城市が本場大島紬の主要産地の一つとして知られる着物の名産地です。精緻な絣と泥染め・草木染の最高級紬は、証紙の有無で査定額が大きく変わります。この記事では、宮崎県内で着物を高く売るためのおすすめ業者5選と、買取相場・高く売るコツを解説します。
          </p>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-4 mt-4 mb-12">
          <div className="bg-[#faf7f3] border-l-4 border-[#6b4c8a] p-4 rounded-r-lg text-sm text-gray-700">
            ...
            <p>宮崎で着物を高く売るなら、本場大島紬に詳しい専門業者へ、証紙を添えて出張買取を依頼するのが最善です。マルキ数や柄、染め・織りの精緻さで査定額が変わるため、必ず2〜3社で相見積もりを取ることが重要です。</p>
          </div>
        </div>
        ...
        <nav className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6 mb-12">
          ...
          <ol className="space-y-2 text-sm text-[#6b4c8a]">
            <li><a href="#orimono" className="hover:underline">1. 宮崎が誇る着物・織物と買取のポイント</a></li>
            <li><a href="#osusume" className="hover:underline">2. 宮崎の着物買取おすすめ業者5選</a></li>
            <li><a href="#houhou" className="hover:underline">3. 出張・持込・宅配の選び方</a></li>
            <li><a href="#kotsu" className="hover:underline">4. 宮崎で着物を高く売る3つのコツ</a></li>
        ...
        <section id="orimono" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">1.</span> 宮崎が誇る着物・織物と買取のポイント
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">宮崎県都城市は、鹿児島・奄美と並ぶ本場大島紬の主要産地の一つです。締機を用いた精緻な絣と、泥染め・草木染による上品な色合いが特徴。絣の細かさを示すマルキ数や柄、証紙の有無が査定額を大きく左右します。</p>
          ...
          <div className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6 mb-4">
            <p className="text-[#6b4c8a] font-bold text-sm mb-2">産地物は「証紙」で価値が決まる</p>
            <p className="text-sm text-gray-700 leading-relaxed">本場大島紬は、産地を示す証紙（旗印・地球印など）が付いているかどうかで査定額が大きく変わります。マルキ数や柄が分かる証紙・証明書は必ず一緒に査定へ出しましょう。</p>
          </div>
          <Link href="/articles/oshima-tsumugi/" className="block bg-white border border-[#e8ddd0] rounded-lg p-5 hover:bg-[#faf8f5] transition-colors group">
            <span className="text-xs text-[#6b4c8a] font-medium">産地・種類</span>
            <p className="text-sm font-bold text-gray-900 mt-1 group-hover:text-[#6b4c8a] transition-colors">本場大島紬の買取相場</p>
            <p className="text-xs text-gray-500 mt-1">本場大島紬（都城・奄美・鹿児島）の買取相場と証紙・マルキ数のポイントを専門ガイドで詳しく解説</p>
          </Link>
        </section>

        <section id="osusume" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">2.</span> 宮崎の着物買取おすすめ業者5選
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">
            宮崎県内の着物買取は、産地織物の知識が豊富な全国対応の専門業者を選ぶのがポイントです。
        ...
        <section id="houhou" className="mb-12">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="border border-[#e8ddd0] rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">点数が多い方に最適。宮崎県内は無料対応が一般的で、自宅で査定を受けられます。</p>
            </div>
            <div className="border border-[#e8ddd0] rounded-lg p-4">
        ...
        <section id="kotsu" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">4.</span> 宮崎で着物を高く売る3つのコツ
          </h2>
          <ol className="space-y-3 text-sm text-gray-700">
            <li className="border border-[#e8ddd0] rounded-lg p-4"><span className="font-bold text-[#6b4c8a]">① 証紙・証明書を必ず添える</span><br />本場大島紬は証紙とマルキ数、柄の精緻さが決め手。証明書を必ず添えましょう。</li>
        ...
        <section id="local-support" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            宮崎県で着物買取のトラブルにあったら（公的な相談先）
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            訪問買取（訪問購入）は特定商取引法の規制対象で、契約書面を受け取った日を含む8日間はクーリング・オフ（無条件解約）ができ、その期間中は着物や貴金属などの品物の引き渡しを拒むこともできます。強引な勧誘や査定額への不安など、業者とのトラブルで困ったときは、宮崎県が運営する
            <a href="https://www.pref.miyazaki.lg.jp/shouhi/index.html" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">宮崎県消費生活センター</a>
            （都城・延岡に支所あり）に相談できます。また、全国共通の消費者ホットライン「<span className="font-bold">188</span>（いやや）」に局番なしでかけると、最寄りの消費生活相談窓口を案内してもらえます。※2026年7月に公式サイトで確認
          </p>
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            電話相談は<span className="font-bold">0985-32-7171</span>（宮崎県消費生活センター／宮崎市江平西2丁目1番20号）へ。※電話番号も2026年7月に公式サイトで確認
          </p>
        ...
        <div className="text-center bg-gradient-to-r from-[#6b4c8a] to-[#8b6aaa] rounded-lg p-8 mb-12">
          <h3 className="text-white text-xl font-bold mb-3">宮崎の着物、まずは無料査定で価値を確認</h3>
          <p className="text-purple-100 text-sm mb-6 leading-relaxed">
            本場大島紬（都城）など、宮崎の織物は専門業者の目で正しく評価されます。<br />
        ...
        <section className="mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <Link href="/articles/okinawa/" className="block bg-white border border-[#e8ddd0] rounded-lg p-4 hover:bg-[#faf8f5] transition-colors group">
              <p className="text-sm font-bold text-gray-900 group-hover:text-[#6b4c8a] transition-colors">沖縄の着物買取</p>
              <p className="text-xs text-gray-500 mt-1">沖縄県内の着物買取おすすめ業者と地元の織物を解説</p>
            </Link>
          </div>
        </section>
