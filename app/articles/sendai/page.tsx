    ...
    <>
      ...
      <section id="oshigai" className="py-10">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <ul className="space-y-2 text-sm text-gray-700 mb-4">
            ...
            <li className="bg-white border border-[#e8ddd0] rounded-xl p-3">万一契約しても、契約書面を受け取った日を含め8日間はクーリング・オフ（無条件解約）ができ、期間中は品物の引き渡しを拒むことができます（詳細は次のセクション）</li>
          </ul>
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            不安を感じたら、<a href="https://www.city.sendai.jp/kehatsu/soudan-annai.html" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">仙台市消費生活センター</a>（消費生活相談ダイヤル 022-268-7867）または全国共通の消費者ホットライン「<span className="font-bold">188</span>」に相談してください。※連絡先は2026年7月に公式サイトで確認
          </p>
      ...
      <section id="local-support" className="py-10">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            「頼んでいないのに業者が来て買い取られた」「解約したいのに応じてくれない」といったトラブルに遭ったら、一人で抱え込まず<a href="https://www.city.sendai.jp/kurashi/tetsuzuki/shohi/index.html" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">仙台市消費生活センター</a>（青葉区・141ビル5階）に相談しましょう。全国共通の消費者ホットライン<strong>「188（いやや！）」</strong>に電話すると、お近くの相談窓口につながります。※2026年7月に公式サイトで確認
          </p>
