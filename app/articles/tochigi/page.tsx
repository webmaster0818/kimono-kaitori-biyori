    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <section id="orimono" className="mb-12">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-6">栃木県は、足利市が銘仙の名産地、小山市が茨城県結城市と並ぶ本場結城紬の産地として知られます。真岡市の真岡木綿も江戸時代から続く丈夫な木綿織物。結城紬は証紙の有無、銘仙は柄の魅力が査定額を大きく左右します。</p>
