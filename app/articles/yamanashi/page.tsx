...
export const metadata: Metadata = {
  title: "【2026年最新】山梨の着物買取おすすめ5選｜甲斐絹を高く売る",
  description:
    "山梨県で着物買取を依頼するならどこがおすすめ？玉虫色の光沢が美しい絹織物「甲斐絹（郡内織）」など山梨が誇る織物の買取相場と、出張・持込・宅配に対応したおすすめ業者5選を比較。証紙の重要性や高く売るコツも解説します。",
  alternates: {
    canonical: "https://kimonokaitori-biyori.com/articles/yamanashi/",
  },
  openGraph: {
    title: "【2026年最新】山梨の着物買取おすすめ5選｜甲斐絹を高く売る",
    description:
      "山梨県で着物を高く売るためのおすすめ買取業者5選。甲斐絹（郡内織）など地元織物の買取相場も解説。",
    url: "https://kimonokaitori-biyori.com/articles/yamanashi/",
    siteName: "着物の買取びより",
    type: "article",
    locale: "ja_JP",
  },
...
const faqs = [
  { question: "山梨の甲斐絹は高く売れますか？", answer: "甲斐絹は山梨を代表する織物で、状態と証紙が揃っていれば評価されます。上質な手織りや証紙付き・作家物のものは特に高く、証紙がないと査定額が下がることがあるため、購入時の証紙は必ず一緒に査定へ出しましょう。正絹の紬・訪問着・帯と一緒にまとめて査定に出すと、全体の買取額が上がりやすくなります。" },
  ...
  { question: "山梨県内で着物の出張買取は無料で来てもらえますか？", answer: "主要な着物買取業者であれば、甲府市・富士吉田市・甲斐市・南アルプス市など県内全域で無料の出張買取に対応しています。買取大吉やウリエルは出張費・査定料・キャンセル料すべて無料で、自宅にいながら査定を受けられます。まずは電話やLINEで対応エリアを確認するとスムーズです。" },
  { question: "山梨で大量の着物をまとめて売れますか？", answer: "はい、出張買取を利用すれば点数制限なく大量の着物をまとめて売却できます。蔵や箪笥に眠っている着物・帯・和装小物をまとめて査定してもらうことで、1点ずつでは値がつきにくい品もまとめ買取で評価されるケースがあります。遺品整理や生前整理でまとまった量がある場合は、事前に点数を伝えておくとスムーズです。" },
  { question: "山梨の着物買取で注意すべき点はありますか？", answer: "突然訪問してきて着物や貴金属の買取を持ちかける「押し買い」には注意してください。信頼できる業者が自ら飛び込み営業をすることはありません。古物商許可を持ち、口コミや実績が確認できる業者を選び、必ず複数社で相見積もりを取りましょう。出張買取は契約日を含め8日間のクーリングオフ対象です。" },
];
...
const articleStructuredData = {
  ...
  headline: "山梨の着物買取おすすめ5選｜甲斐絹を高く売る",
  description:
    "山梨県で着物を高く売るためのおすすめ買取業者5選。甲斐絹（郡内織）など地元織物の買取相場も解説。",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://kimonokaitori-biyori.com/articles/yamanashi/",
  },
};
...
const breadcrumbStructuredData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "山梨の着物買取", item: "https://kimonokaitori-biyori.com/articles/yamanashi/" },
  ],
};

const orimono = [
  { name: "甲斐絹（かいき／郡内織）", note: "玉虫色の光沢と緻密な絣・縞が美しい高級絹織物。羽織裏・裏地の最高級品として珍重された。" },
  { name: "郡内の絹織物", note: "富士吉田・西桂など郡内地方の上質な絹織物。状態の良いものは評価される。" },
  { name: "正絹の訪問着・紬", note: "甲斐絹以外の上質な着物も買取対象。証紙付き・作家物は高評価。" },
  { name: "帯・和装小物", note: "袋帯・名古屋帯や帯締め・帯揚げもまとめて査定対象。" },
];

export default function YamanashiPage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ label: "お役立ち情報", href: "/articles/" }, { label: "山梨の着物買取" }]} />

      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-12 rounded-2xl p-6 md:p-10 border border-[#e8ddd0]" style={{ backgroundImage: "linear-gradient(135deg, rgba(248,243,250,0.45), rgba(252,248,242,0.40)), url('/images/heroes/yamanashi.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
            山梨の着物買取おすすめ<span className="text-[#6b4c8a]">5選</span>
            <br className="md:hidden" />
            甲斐絹を高く売る
          </h1>
          <p className="text-gray-600 leading-relaxed">
            山梨は、玉虫色の光沢と緻密な絣・縞が美しい高級絹織物「甲斐絹（かいき）」を生んだ郡内織の名産地です。羽織裏や裏地の最高級品として珍重されてきました。この記事では、山梨県内で着物を高く売るためのおすすめ業者5選と、買取相場・高く売るコツを解説します。
          </p>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-4 mt-4 mb-12">
          <div className="bg-[#faf7f3] border-l-4 border-[#6b4c8a] p-4 rounded-r-lg text-sm text-gray-700">
            ...
            <p>山梨で着物を高く売るなら、甲斐絹をはじめ上質な絹織物に詳しい専門業者へ、証紙を添えて出張買取を依頼するのが最善です。県内全域で無料出張に対応する業者が多く、必ず2〜3社で相見積もりを取りましょう。</p>
          </div>
        </div>
        ...
        <nav className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6 mb-12">
          ...
          <ol className="space-y-2 text-sm text-[#6b4c8a]">
            <li><a href="#orimono" className="hover:underline">1. 山梨が誇る着物・織物と買取のポイント</a></li>
            <li><a href="#osusume" className="hover:underline">2. 山梨の着物買取おすすめ業者5選</a></li>
            <li><a href="#houhou" className="hover:underline">3. 出張・持込・宅配の選び方</a></li>
            <li><a href="#kotsu" className="hover:underline">4. 山梨で着物を高く売る3つのコツ</a></li>
        ...
        <section id="orimono" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">1.</span> 山梨が誇る着物・織物と買取のポイント
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">山梨県郡内地方（富士吉田・西桂など）で織られる「甲斐絹」は、細い絹糸を先染めして織る平織で、玉虫色の光沢と緻密な柄が特徴です。江戸時代から羽織裏や裏地の高級品として珍重されました。上質さと証紙の有無が査定額を大きく左右します。</p>
          ...
          <div className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">甲斐絹などの上質な絹織物は、証紙や落款・証明書があると査定額が大きく変わります。羽織や裏地、たとう紙の証明書も必ず一緒に査定へ出しましょう。</p>
          </div>
        ...
        <section id="osusume" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">2.</span> 山梨の着物買取おすすめ業者5選
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">
            山梨県内の着物買取は、産地織物の知識が豊富な全国対応の専門業者を選ぶのがポイントです。
        ...
        <section id="houhou" className="mb-12">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="border border-[#e8ddd0] rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">点数が多い方に最適。山梨県内は無料対応が一般的で、自宅で査定を受けられます。</p>
            </div>
            <div className="border border-[#e8ddd0] rounded-lg p-4">
        ...
        <section id="kotsu" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">4.</span> 山梨で着物を高く売る3つのコツ
          </h2>
          <ol className="space-y-3 text-sm text-gray-700">
            <li className="border border-[#e8ddd0] rounded-lg p-4"><span className="font-bold text-[#6b4c8a]">① 証紙・証明書を必ず添える</span><br />甲斐絹は玉虫色の光沢と緻密な柄の上質さが決め手。証紙・証明書があれば必ず添えましょう。</li>
        ...
        <section id="local-support" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            山梨県で着物買取のトラブルにあったら（公的な相談先）
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            訪問買取（訪問購入）は特定商取引法の規制対象で、契約書面を受け取った日を含む8日間はクーリング・オフ（無条件解約）ができ、その期間中は着物や貴金属などの品物の引き渡しを拒むこともできます。強引な勧誘や査定額への不安など、業者とのトラブルで困ったときは、山梨県が運営する
            <a href="https://www.pref.yamanashi.jp/kenminskt-c/" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">山梨県県民生活センター</a>
            （消費生活相談・電話 055-235-8455）に相談できます。また、全国共通の消費者ホットライン「<span className="font-bold">188</span>（いやや）」に局番なしでかけると、最寄りの消費生活相談窓口を案内してもらえます。※2026年7月に公式サイトで確認
          </p>
        ...
        <div className="text-center bg-gradient-to-r from-[#6b4c8a] to-[#8b6aaa] rounded-lg p-8 mb-12">
          <h3 className="text-white text-xl font-bold mb-3">山梨の着物、まずは無料査定で価値を確認</h3>
          <p className="text-purple-100 text-sm mb-6 leading-relaxed">
            甲斐絹（郡内織）など、山梨の絹織物は専門業者の目で正しく評価されます。<br />
