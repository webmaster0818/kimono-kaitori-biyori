...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://kimonokaitori-biyori.com/articles/gifu/",
  },
  openGraph: {
    title: "【2026年最新】岐阜の着物買取おすすめ5選｜郡上紬を高く売る",
    description:
      "岐阜県で着物を高く売るためのおすすめ買取業者5選。郡上紬など地元織物の買取相場も解説。",
    url: "https://kimonokaitori-biyori.com/articles/gifu/",
    siteName: "着物の買取びより",
    type: "article",
    locale: "ja_JP",
  },
...
const faqs = [
  { question: "岐阜の郡上紬は高く売れますか？", answer: "はい、郡上紬は草木染・手織りの芸術性の高い紬で、状態と証紙・落款が揃っていれば高価買取が期待できます。特に人間国宝・宗廣力三など著名作家の作品は希少で評価が非常に高くなります。証明がないと作家物であっても査定額が下がるため、落款・証紙は必ず一緒に査定へ出しましょう。" },
  { question: "作家物の紬は証明書がないと売れませんか？", answer: "証明書がなくても買取は可能ですが、作家物は証明（落款・証紙・共箱・購入時の資料）があるかどうかで査定額が大きく変わります。郡上紬のような作家物は、関連する資料を一緒に出すことで適正に評価されやすくなります。" },
  { question: "岐阜県内で着物の出張買取は無料で来てもらえますか？", answer: "主要な着物買取業者であれば、岐阜市・大垣市・高山市・郡上市など県内全域で無料の出張買取に対応しています。買取大吉やウリエルは出張費・査定料・キャンセル料すべて無料で、自宅にいながら査定を受けられます。山間部でも対応可能なことが多いです。" },
  { question: "岐阜で大量の着物をまとめて売れますか？", answer: "はい、出張買取を利用すれば点数制限なく大量の着物をまとめて売却できます。蔵や箪笥に眠っている着物・帯・和装小物をまとめて査定してもらうことで、1点ずつでは値がつきにくい品もまとめ買取で評価されるケースがあります。遺品整理や生前整理でまとまった量がある場合は、事前に点数を伝えておくとスムーズです。" },
  { question: "岐阜の着物買取で注意すべき点はありますか？", answer: "突然訪問してきて着物や貴金属の買取を持ちかける「押し買い」には注意してください。信頼できる業者が自ら飛び込み営業をすることはありません。古物商許可を持ち、口コミや実績が確認できる業者を選び、必ず複数社で相見積もりを取りましょう。出張買取は契約日を含め8日間のクーリングオフ対象です。" },
];
...
const articleStructuredData = {
  ...
  headline: "岐阜の着物買取おすすめ5選｜郡上紬を高く売る",
  description:
    "岐阜県で着物を高く売るためのおすすめ買取業者5選。郡上紬など地元織物の買取相場も解説。",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://kimonokaitori-biyori.com/articles/gifu/",
  },
};
...
const breadcrumbStructuredData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "岐阜の着物買取", item: "https://kimonokaitori-biyori.com/articles/gifu/" },
  ],
};

const orimono = [
  { name: "郡上紬（ぐじょうつむぎ）", note: "郡上市の草木染・手織りの紬。人間国宝・宗廣力三が再興。作家物は特に高評価。" },
  { name: "宗廣力三 作の郡上紬", note: "重要無形文化財保持者の作品は希少で高額。落款・証明があれば必ず添える。" },
  { name: "正絹の訪問着・帯", note: "上質な着物全般が買取対象。証紙付き・作家物は高評価。" },
...
export default function GifuPage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ label: "お役立ち情報", href: "/articles/" }, { label: "岐阜の着物買取" }]} />

      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-12 rounded-2xl p-6 md:p-10 border border-[#e8ddd0]" style={{ backgroundImage: "linear-gradient(135deg, rgba(248,243,250,0.45), rgba(252,248,242,0.40)), url('/images/heroes/gifu.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
            岐阜の着物買取おすすめ<span className="text-[#6b4c8a]">5選</span>
            <br className="md:hidden" />
            郡上紬を高く売る
          </h1>
          <p className="text-gray-600 leading-relaxed">
            岐阜は、草木染の素朴で力強い風合いが魅力の「郡上紬（ぐじょうつむぎ）」を生んだ着物の名産地です。郡上紬は人間国宝・宗廣力三によって再興され、その芸術性が高く評価されています。この記事では、岐阜県内で着物を高く売るためのおすすめ業者5選と、買取相場・高く売るコツを解説します。
          </p>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-4 mt-4 mb-12">
          <div className="bg-[#faf7f3] border-l-4 border-[#6b4c8a] p-4 rounded-r-lg text-sm text-gray-700">
            ...
            <p>岐阜で着物を高く売るなら、郡上紬をはじめ上質な紬に詳しい専門業者へ、証紙・落款を添えて出張買取を依頼するのが最善です。作家物の郡上紬は特に評価が高いので、必ず2〜3社で相見積もりを取りましょう。</p>
          </div>
        </div>
        ...
        <nav className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6 mb-12">
          ...
          <ol className="space-y-2 text-sm text-[#6b4c8a]">
            <li><a href="#orimono" className="hover:underline">1. 岐阜が誇る着物・織物と買取のポイント</a></li>
            <li><a href="#osusume" className="hover:underline">2. 岐阜の着物買取おすすめ業者5選</a></li>
            <li><a href="#houhou" className="hover:underline">3. 出張・持込・宅配の選び方</a></li>
            <li><a href="#kotsu" className="hover:underline">4. 岐阜で着物を高く売る3つのコツ</a></li>
        ...
        <section id="orimono" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">1.</span> 岐阜が誇る着物・織物と買取のポイント
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">岐阜県郡上市で織られる「郡上紬」は、草木染と手織りによる素朴で力強い風合いが特徴です。人間国宝・宗廣力三が伝統技法を再興したことで知られ、芸術性の高い作品は買取市場でも高く評価されます。証紙・落款の有無が査定額を大きく左右します。</p>
          ...
          <div className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">郡上紬は、証紙や作家の落款・証明書があると査定額が大きく変わります。特に宗廣力三など著名作家の作品は証明があれば高評価。たとう紙の証明書も必ず一緒に査定へ出しましょう。</p>
          </div>
        </section>

        <section id="osusume" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">2.</span> 岐阜の着物買取おすすめ業者5選
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">
            岐阜県内の着物買取は、産地織物の知識が豊富な全国対応の専門業者を選ぶのがポイントです。
        ...
        <section id="houhou" className="mb-12">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="border border-[#e8ddd0] rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">点数が多い方に最適。岐阜県内は無料対応が一般的で、自宅で査定を受けられます。</p>
            </div>
            <div className="border border-[#e8ddd0] rounded-lg p-4">
        ...
        <section id="kotsu" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">4.</span> 岐阜で着物を高く売る3つのコツ
          </h2>
          <ol className="space-y-3 text-sm text-gray-700">
            <li className="border border-[#e8ddd0] rounded-lg p-4"><span className="font-bold text-[#6b4c8a]">① 証紙・証明書を必ず添える</span><br />郡上紬は証紙・作家の落款が決め手。著名作家の作品は証明書を必ず添えましょう。</li>
        ...
        <div className="text-center bg-gradient-to-r from-[#6b4c8a] to-[#8b6aaa] rounded-lg p-8 mb-12">
          <h3 className="text-white text-xl font-bold mb-3">岐阜の着物、まずは無料査定で価値を確認</h3>
          <p className="text-purple-100 text-sm mb-6 leading-relaxed">
            郡上紬など、岐阜の織物は専門業者の目で正しく評価されます。<br />
