...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://kimonokaitori-biyori.com/articles/kagoshima/",
  },
  openGraph: {
    title: "【2026年最新】鹿児島の着物買取おすすめ5選｜本場大島紬を高く売る",
    description:
      "鹿児島県で着物を高く売るためのおすすめ買取業者5選。本場大島紬・薩摩絣など地元織物の買取相場も解説。",
    url: "https://kimonokaitori-biyori.com/articles/kagoshima/",
    siteName: "着物の買取びより",
    type: "article",
    locale: "ja_JP",
  },
...
const faqs = [
  { question: "鹿児島の本場大島紬は高く売れますか？", answer: "はい、本場大島紬は最高級の絹織物で、状態と証紙（旗印・地球印）が揃っていれば高価買取が期待できます。特にマルキ数の大きい精緻な絣（9マルキなど）や、龍郷柄・亀甲柄の上質品は評価が高くなります。証紙がないと本場品であっても査定額が大きく下がるため、必ず証紙を一緒に査定へ出しましょう。" },
  { question: "大島紬の「マルキ」とは何ですか？査定に関係しますか？", answer: "マルキとは絣糸の本数を示す単位で、数が大きいほど絣が細かく手間がかかっており、一般に査定額も高くなります。5マルキ・7マルキ・9マルキなどがあり、証紙にマルキ数が記載されています。査定時の重要な評価ポイントになるため、証紙は必ず添えてください。" },
  { question: "鹿児島県内で着物の出張買取は無料で来てもらえますか？", answer: "主要な着物買取業者であれば、鹿児島市・霧島市・鹿屋市など県内全域で無料の出張買取に対応しています。買取大吉やウリエルは出張費・査定料・キャンセル料すべて無料で、自宅にいながら査定を受けられます。離島の場合は宅配買取が便利なので、まずは対応方法を電話やLINEで確認するとスムーズです。" },
  { question: "鹿児島で大量の着物をまとめて売れますか？", answer: "はい、出張買取を利用すれば点数制限なく大量の着物をまとめて売却できます。大島紬は1点でも高額になりやすいですが、他の着物・帯・和装小物もまとめて査定してもらうことで全体の買取額が上がるケースがあります。遺品整理や生前整理でまとまった量がある場合は、事前に点数を伝えておくと当日の査定がスムーズです。" },
  { question: "鹿児島の着物買取で注意すべき点はありますか？", answer: "突然訪問してきて着物や貴金属の買取を持ちかける「押し買い」には注意してください。信頼できる業者が自ら飛び込み営業をすることはありません。大島紬は業者によって評価差が出やすいため、必ず複数社で相見積もりを取りましょう。出張買取は契約日を含め8日間のクーリングオフ対象です。" },
];
...
const articleStructuredData = {
  ...
  headline: "鹿児島の着物買取おすすめ5選｜本場大島紬を高く売る",
  description:
    "鹿児島県で着物を高く売るためのおすすめ買取業者5選。本場大島紬・薩摩絣など地元織物の買取相場も解説。",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://kimonokaitori-biyori.com/articles/kagoshima/",
  },
};
...
const breadcrumbStructuredData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "鹿児島の着物買取", item: "https://kimonokaitori-biyori.com/articles/kagoshima/" },
  ],
};

const orimono = [
  { name: "本場大島紬（泥染め）", note: "テーチ木と泥による泥染め・締機の絣が特徴の最高級紬。証紙とマルキ数が価値の決め手。" },
  { name: "龍郷柄・亀甲柄", note: "大島紬の代表的な伝統柄。精緻な絣ほど手間がかかり評価が高い。" },
  { name: "白大島・色大島・藍大島", note: "泥染め以外の大島紬。生地の上質さと証紙の有無で評価が決まる。" },
  { name: "薩摩絣ほか", note: "薩摩地方の絣木綿。素朴な味わいがあり、状態の良いものは買取対象。" },
];
...
export default function KagoshimaPage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ label: "お役立ち情報", href: "/articles/" }, { label: "鹿児島の着物買取" }]} />

      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-12 rounded-2xl p-6 md:p-10 border border-[#e8ddd0]" style={{ backgroundImage: "linear-gradient(135deg, rgba(248,243,250,0.45), rgba(252,248,242,0.40)), url('/images/heroes/kagoshima.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">
            鹿児島の着物買取おすすめ<span className="text-[#6b4c8a]">5選</span>
            <br className="md:hidden" />
            本場大島紬を高く売る
          </h1>
          <p className="text-gray-600 leading-relaxed">
            鹿児島は、最高級の絹織物として名高い「本場大島紬」の本場として知られる、着物の名産地です。泥染めと精緻な絣が織りなす本場大島紬は世界的にも評価が高く、証紙の有無で査定額が大きく変わります。この記事では、鹿児島県内で着物を高く売るためのおすすめ買取業者5選と、買取相場・高く売るコツを解説します。
          </p>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-4 mt-4 mb-12">
          <div className="bg-[#faf7f3] border-l-4 border-[#6b4c8a] p-4 rounded-r-lg text-sm text-gray-700">
            ...
            <p>鹿児島で着物を高く売るなら、本場大島紬に詳しい専門業者へ、証紙（旗印・地球印）を添えて出張買取を依頼するのが最善です。マルキ数や柄、染め・織りの精緻さで査定額が変わるため、必ず2〜3社で相見積もりを取ることが重要です。</p>
          </div>
        </div>
        ...
        <nav className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6 mb-12">
          ...
          <ol className="space-y-2 text-sm text-[#6b4c8a]">
            <li><a href="#orimono" className="hover:underline">1. 鹿児島が誇る着物・織物と買取のポイント</a></li>
            <li><a href="#osusume" className="hover:underline">2. 鹿児島の着物買取おすすめ業者5選</a></li>
            <li><a href="#houhou" className="hover:underline">3. 出張・持込・宅配の選び方</a></li>
            <li><a href="#kotsu" className="hover:underline">4. 鹿児島で着物を高く売る3つのコツ</a></li>
        ...
        <section id="orimono" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">1.</span> 鹿児島が誇る着物・織物と買取のポイント
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">鹿児島県は奄美大島とともに本場大島紬の二大産地で、テーチ木と泥による泥染め、締機（しめばた）を用いた精緻な絣が特徴です。「龍郷柄」「亀甲柄」など伝統柄や、絣の細かさを示すマルキ数（5マルキ・7マルキ・9マルキ）が価値を左右します。証紙の有無が査定額を大きく左右します。</p>
          ...
          <div className="bg-[#faf8f5] border border-[#e8ddd0] rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">本場大島紬は、鹿児島県産を示す「旗印」や奄美産を示す「地球印」などの証紙が付いているかどうかで査定額が大きく変わります。マルキ数や柄が分かる証紙・証明書は必ず一緒に査定へ出しましょう。</p>
          </div>
        </section>

        <section id="osusume" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">2.</span> 鹿児島の着物買取おすすめ業者5選
          </h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-6">
            鹿児島県内の着物買取は、産地織物の知識が豊富な全国対応の専門業者を選ぶのがポイントです。
        ...
        <section id="houhou" className="mb-12">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="border border-[#e8ddd0] rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">点数が多い方に最適。鹿児島県内は無料対応が一般的で、自宅で査定を受けられます。</p>
            </div>
            <div className="border border-[#e8ddd0] rounded-lg p-4">
        ...
        <section id="kotsu" className="mb-12">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-[#6b4c8a]">
            <span className="text-[#c9a76c]">4.</span> 鹿児島で着物を高く売る3つのコツ
          </h2>
          <ol className="space-y-3 text-sm text-gray-700">
            <li className="border border-[#e8ddd0] rounded-lg p-4"><span className="font-bold text-[#6b4c8a]">① 証紙・証明書を必ず添える</span><br />本場大島紬は証紙（旗印・地球印）とマルキ数で査定額が大きく変わります。証明書を必ず添えましょう。</li>
        ...
        <div className="text-center bg-gradient-to-r from-[#6b4c8a] to-[#8b6aaa] rounded-lg p-8 mb-12">
          <h3 className="text-white text-xl font-bold mb-3">鹿児島の着物、まずは無料査定で価値を確認</h3>
          <p className="text-purple-100 text-sm mb-6 leading-relaxed">
            本場大島紬・薩摩絣など、鹿児島の織物は専門業者の目で正しく評価されます。<br />
