...
const datasetStructuredData = {"@context": "https://schema.org", "@type": "Dataset", "name": "加賀友禅の実売相場データ（公開オークション落札相場）", "description": "加賀友禅について、公開オークション（Yahoo!オークションの落札相場）で実際に売買が成立した落札件数・平均落札価格・最高落札価格を集計した実売データ（一次情報）です。買取業者の査定額ではなく、個人間取引で成立した実売価格の集計値です。", "creator": {"@type": "Organization", "name": "着物の買取びより", "url": "https://kimonokaitori-biyori.com"}, "publisher": {"@type": "Organization", "name": "着物の買取びより", "url": "https://kimonokaitori-biyori.com"}, "isBasedOn": "https://auctions.yahoo.co.jp/closedsearch/closedsearch/%E5%8A%A0%E8%B3%80%E5%8F%8B%E7%A6%85/0/", "variableMeasured": ["落札件数", "平均落札価格", "最高落札価格"], "measurementTechnique": "公開オークションの落札相場ページの手動集計（推定値・出典不明の数値は不採用）", "temporalCoverage": "P180D", "dateModified": "2026-08-24", "url": "https://kimonokaitori-biyori.com/articles/kaga-yuzen/#auction-data", "isAccessibleForFree": true};
...
export default function KagaYuzenPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="py-12 md:py-16 section-primary-light" style={{ backgroundImage: "linear-gradient(135deg, rgba(248,243,250,0.45), rgba(252,248,242,0.40)), url('/images/heroes/kaga-yuzen.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white border-2 border-[#6b4c8a] rounded-xl p-5 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
              <div><span className="text-gray-500">落札件数（直近30日）</span><br /><span className="text-lg font-bold">79件</span></div>
              <div><span className="text-gray-500">平均落札価格</span><br /><span className="text-lg font-bold">約15,654円</span></div>
              <div><span className="text-gray-500">最高落札価格（過去約180日・単品）</span><br /><span className="text-lg font-bold">550,000円</span><br /><span className="text-xs text-gray-500">二代目由水十久 訪問着(単品)</span></div>
            </div>
            <p className="text-xs text-gray-500 mt-3">出典: オークファン（aucfan.com）の加賀友禅落札相場ページ・Yahoo!オークション落札相場（2026年8月24日取得）。作家物が最高値帯を形成しています。以下の区分別テーブルは前回集計（取得日記載）です。</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
              ...
              <tbody>
                  <tr><td className="border border-[#e8ddd0] px-3 py-2">加賀友禅（全般）</td><td className="border border-[#e8ddd0] px-3 py-2">約9,659円</td><td className="border border-[#e8ddd0] px-3 py-2">275,000円</td></tr>
                  <tr><td className="border border-[#e8ddd0] px-3 py-2">訪問着</td><td className="border border-[#e8ddd0] px-3 py-2">約14,459円</td><td className="border border-[#e8ddd0] px-3 py-2">275,000円</td></tr>
                  <tr><td className="border border-[#e8ddd0] px-3 py-2">留袖</td><td className="border border-[#e8ddd0] px-3 py-2">約12,931円</td><td className="border border-[#e8ddd0] px-3 py-2">198,000円</td></tr>
                  <tr><td className="border border-[#e8ddd0] px-3 py-2">反物</td><td className="border border-[#e8ddd0] px-3 py-2">約13,131円</td><td className="border border-[#e8ddd0] px-3 py-2">151,000円</td></tr>
                  <tr><td className="border border-[#e8ddd0] px-3 py-2">帯</td><td className="border border-[#e8ddd0] px-3 py-2">約20,533円</td><td className="border border-[#e8ddd0] px-3 py-2">－</td></tr>
              </tbody>
            </table>
          </div>
          <p className="text-xs text-gray-500 mt-2">
            出典：<a href="https://auctions.yahoo.co.jp/closedsearch/closedsearch/%E5%8A%A0%E8%B3%80%E5%8F%8B%E7%A6%85/0/" target="_blank" rel="noopener noreferrer" className="text-[#6b4c8a] underline">Yahoo!オークション 落札相場</a>（2026年6月取得）。参考：オークファン集計では加賀友禅 着物の直近90日落札280件・平均約4,039円です
          </p>
          <div className="bg-[#fdf6f6] border border-[#e8b4b4] rounded-lg p-4 mt-5 text-sm text-gray-700 leading-relaxed">
            ...
            上記は公開オークションで実際に売買された“実売価格”の集計です。買取業者の査定額（買取価格）とは異なり、一般に買取価格は実売価格より低くなります。1円〜の極端な安値は証紙なし・状態不良・入札不成立に近い例も含むため、価格帯の“幅”の参考としてご覧ください。加賀友禅は作家・落款の有無で価値が大きく変わります。金額は取得時点のもので、相場は時期・状態により変動し、査定額を保証するものではありません。
          </div>
          <p className="text-xs text-gray-500 mt-3">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-[#faf7f3] border border-[#e8ddd0] rounded-xl p-6 md:p-7">
            <h2 className="text-lg md:text-xl font-bold text-[#6b4c8a] mb-4 flex items-center gap-2">
              ...
              加賀友禅を売るなら｜状況別のおすすめ買取方法
            </h2>
            <p className="text-sm text-gray-700 leading-relaxed mb-5">
              加賀友禅は証紙・作家・状態によって評価が大きく変わります。あなたの状況に合わせて、最適な売り方を選びましょう。
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/ranking/" className="block bg-white border border-[#e8ddd0] rounded-lg p-5 hover:border-[#6b4c8a] transition-colors group">
                ...
                <p className="text-xs text-gray-600">価値の高い加賀友禅は業者で査定額の差が出やすいため、おすすめ買取業者ランキングで複数社を比較するのが有利です。</p>
              </Link>
