  ...
  return (
    <>
      ...
      <section className="mb-10">
        ...
        <Link href="/articles/tenpo-mochikomi/" className="block px-4 py-3 rounded-lg border border-[#e8ddd0] bg-white hover:border-[#6b4c8a] hover:bg-[#faf7f3] transition-colors text-sm text-gray-700 hover:text-[#6b4c8a]">着物の持ち込み買取おすすめ業者2選｜店舗に持っていくメリットと注意点</Link>
